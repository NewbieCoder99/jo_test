<div class="row">
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="form-group">
			{{ Form::label('about','About',['for'=>'about']) }}
			<textarea class="form-control about" name="about" id="about">{{$data->about}}</textarea>
		</div>
	</div>
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="form-group">
			{{ Form::label('contact','Contact', ['for'=>'contact']) }}
			<textarea class="form-control contact" name="contact" id="contact">{{$data->contact}}</textarea>
		</div>
	</div>
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="form-group">
			{{ Form::label('our_team','Our Team', ['for' => 'our_team']) }}
			<textarea class="form-control our_team" name="our_team" id="our_team">{{$data->our_team}}</textarea>
		</div>
	</div>
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="form-group">
			{{ Form::label('services','Services', ['for' => 'services']) }}
			<textarea class="form-control services" name="services" id="services">{{$data->services}}</textarea>
		</div>
	</div>
	<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
		<div class="form-group">
